...
namespace ControleEstoqueWeb.Controllers.Cadastro
{
    ...
    public class CadLocalArmazenamentoController : Controller
    {
        ...
        public JsonResult LocalArmazenamentoPagina(int pagina, int tamanhoPagina)
        {
            var lista = LocalArmazenamentoModel.RecuperarLista(pagina, tamanhoPagina);
